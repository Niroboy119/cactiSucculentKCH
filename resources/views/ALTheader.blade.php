						...
						<div class="top-search">
				            <div class="container" style="margin-right: 500px;">
				                <div class="input-group">
				                    <span class="input-group-addon" style="padding-left:300px;"><i class="fa fa-search"></i></span>
				                    <input onchange = "search()" id ="searchBar2" type="text" style="padding-lef:200px;" class="form-control" placeholder="Search">
								...
								<li class="dropdown">
									...
									@if($count != 0)
										<ul id="cartdrop" class="dropdown-menu cart-list s-cate">
											...
											@endforeach
											<li class="total">
												<button class="btn-cart pull-right" style="width:100%;"><a href="{{ url('/deleteNotification'.'/'.$notification['user_Id']) }}" >Clear All Notifications</a></button>
				                            </li>
										@endif
